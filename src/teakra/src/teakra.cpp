...
namespace Teakra
{
    ...
    struct Teakra::Impl
    {
        ...
        Impl()
        {
            ...
            timer[0].SetInterruptHandler([this]()
                                         { icu.TriggerSingle(0xA); });
            timer[1].SetInterruptHandler([this]()
            ...
            btdmp[0].SetInterruptHandler([this]()
                                         { icu.TriggerSingle(0xB); });
            btdmp[1].SetInterruptHandler([this]()
                                         { icu.TriggerSingle(0xB); });

            dma.SetInterruptHandler([this]()
                                    { icu.TriggerSingle(0xF); });
        }
