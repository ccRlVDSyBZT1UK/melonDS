...
namespace ARMJIT_Memory
{
        ...
        void Unmap(int region)
        {
            ...
            while (offset < Size)
            {
                ...
                else
                {
                    ...
                    while (statuses[(Addr + offset) >> 12] == status && offset < Size && (!skipDTCM || Addr + offset != dtcmStart))
                    {
            ...
            if (Num == 0 && dtcmEnd >= Addr && dtcmStart < Addr + Size)
            {
                bool success;
                if (dtcmStart > Addr)
                {
    ...
    void SetCodeProtection(int region, u32 offset, bool protect)
    {
        ...
        for (int i = 0; i < Mappings[region].Length; i++)
        {
            ...
            if (mapping.Num == 0 && region != memregion_DTCM && (effectiveAddr & NDS::ARM9->DTCMMask) == NDS::ARM9->DTCMBase)
                continue;
    ...
    void RemapDTCM(u32 newBase, u32 newSize)
    {
        ...
        for (int region = 0; region < memregions_Count; region++)
        {
            ...
            for (int i = 0; i < Mappings[region].Length;)
            {
                ...
                bool overlap = (oldDTCMSize > 0 && oldDTCMBase < end && oldDTCMEnd > start) || (newSize > 0 && newBase < end && newEnd > start);
    ...
    void RemapNWRAM(int num)
    {
        for (int i = 0; i < Mappings[memregion_SharedWRAM].Length;)
        {
            ...
            if (DSi::NWRAMStart[mapping.Num][num] < mapping.Addr + mapping.Size && DSi::NWRAMEnd[mapping.Num][num] > mapping.Addr)
            {
    ...
    bool MapAtAddress(u32 addr)
    {
...
#ifndef __SWITCH__
#ifndef _WIN32
        if (num == 0 && dtcmEnd >= mirrorStart && dtcmStart < mirrorStart + mirrorSize)
        {
            bool success;
        ...
        while (offset < mirrorSize)
        {
            ...
            else
            {
                ...
                while (offset < mirrorSize && (!isExecutable || ARMJIT::PageContainsCode(&range[offset / 512]) == hasCode) && (!skipDTCM || mirrorStart + offset != NDS::ARM9->DTCMBase))
                {
    ...
    */
        if (region == memregion_DTCM || region == memregion_SharedWRAM || region == memregion_NewSharedWRAM_B || region == memregion_NewSharedWRAM_C)
            return false;
#endif
    ...
    void VRAMWrite(u32 addr, T val)
    {
        ...
        {
        case 0x00000000:
            GPU::WriteVRAM_ABG<T>(addr, val);
            return;
        case 0x00200000:
            GPU::WriteVRAM_BBG<T>(addr, val);
            return;
        case 0x00400000:
            GPU::WriteVRAM_AOBJ<T>(addr, val);
            return;
        case 0x00600000:
            GPU::WriteVRAM_BOBJ<T>(addr, val);
            return;
        default:
            GPU::WriteVRAM_LCDC<T>(addr, val);
            return;
        }
    }
    template <typename T>
    T VRAMRead(u32 addr)
    {
        ...
        {
        case 0x00000000:
            return GPU::ReadVRAM_ABG<T>(addr);
        case 0x00200000:
            return GPU::ReadVRAM_BBG<T>(addr);
        case 0x00400000:
            return GPU::ReadVRAM_AOBJ<T>(addr);
        case 0x00600000:
            return GPU::ReadVRAM_BOBJ<T>(addr);
        default:
            return GPU::ReadVRAM_LCDC<T>(addr);
        }
    }
        ...
        if (cpu->Num == 0)
        {
            ...
            */
                if (addr >= 0x04000320 && addr < 0x040006A4)
                {
                    ...
                    {
                    case 8:
                        return (void *)GPU3D::Read8;
                    case 9:
                        return (void *)GPU3D::Write8;
                    case 16:
                        return (void *)GPU3D::Read16;
                    case 17:
                        return (void *)GPU3D::Write16;
                    case 32:
                        return (void *)GPU3D::Read32;
                    case 33:
                        return (void *)GPU3D::Write32;
                    }
                }
                ...
                if (NDS::ConsoleType == 0)
                {
                    ...
                    {
                    case 8:
                        return (void *)NDS::ARM9IORead8;
                    case 9:
                        return (void *)NDS::ARM9IOWrite8;
                    case 16:
                        return (void *)NDS::ARM9IORead16;
                    case 17:
                        return (void *)NDS::ARM9IOWrite16;
                    case 32:
                        return (void *)NDS::ARM9IORead32;
                    case 33:
                        return (void *)NDS::ARM9IOWrite32;
                    }
                }
                else
                {
                    ...
                    {
                    case 8:
                        return (void *)DSi::ARM9IORead8;
                    case 9:
                        return (void *)DSi::ARM9IOWrite8;
                    case 16:
                        return (void *)DSi::ARM9IORead16;
                    case 17:
                        return (void *)DSi::ARM9IOWrite16;
                    case 32:
                        return (void *)DSi::ARM9IORead32;
                    case 33:
                        return (void *)DSi::ARM9IOWrite32;
                    }
                }
                break;
            case 0x06000000:
                ...
                {
                case 8:
                    return (void *)VRAMRead<u8>;
                case 9:
                    return NULL;
                case 16:
                    return (void *)VRAMRead<u16>;
                case 17:
                    return (void *)VRAMWrite<u16>;
                case 32:
                    return (void *)VRAMRead<u32>;
                case 33:
                    return (void *)VRAMWrite<u32>;
                }
                break;
            }
        }
        else
        {
            ...
            case 0x04000000:
                if (addr >= 0x04000400 && addr < 0x04000520)
                {
                    ...
                    {
                    case 8:
                        return (void *)SPU::Read8;
                    case 9:
                        return (void *)SPU::Write8;
                    case 16:
                        return (void *)SPU::Read16;
                    case 17:
                        return (void *)SPU::Write16;
                    case 32:
                        return (void *)SPU::Read32;
                    case 33:
                        return (void *)SPU::Write32;
                    }
                }
                ...
                if (NDS::ConsoleType == 0)
                {
                    ...
                    {
                    case 8:
                        return (void *)NDS::ARM7IORead8;
                    case 9:
                        return (void *)NDS::ARM7IOWrite8;
                    case 16:
                        return (void *)NDS::ARM7IORead16;
                    case 17:
                        return (void *)NDS::ARM7IOWrite16;
                    case 32:
                        return (void *)NDS::ARM7IORead32;
                    case 33:
                ...
                else
                {
                    ...
                    {
                    case 8:
                        return (void *)DSi::ARM7IORead8;
                    case 9:
                        return (void *)DSi::ARM7IOWrite8;
                    case 16:
                        return (void *)DSi::ARM7IORead16;
                    case 17:
                        return (void *)DSi::ARM7IOWrite16;
                    case 32:
                        return (void *)DSi::ARM7IORead32;
                    case 33:
                        return (void *)DSi::ARM7IOWrite32;
                    }
                }
                break;
            case 0x04800000:
                if (addr < 0x04810000 && size >= 16)
                {
                    ...
                    case 32:
                        return (void *)WifiRead32;
                    case 33:
                        return (void *)WifiWrite32;
                    }
                }
                break;
            case 0x06000000:
            case 0x06800000:
                ...
                {
                case 8:
                    return (void *)GPU::ReadVRAM_ARM7<u8>;
                case 9:
                    return (void *)GPU::WriteVRAM_ARM7<u8>;
                case 16:
                    return (void *)GPU::ReadVRAM_ARM7<u16>;
                case 17:
                    return (void *)GPU::WriteVRAM_ARM7<u16>;
                case 32:
                    return (void *)GPU::ReadVRAM_ARM7<u32>;
                case 33:
                    return (void *)GPU::WriteVRAM_ARM7<u32>;
                }
            }
        }
        return NULL;
